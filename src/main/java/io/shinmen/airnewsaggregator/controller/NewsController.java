...
public class NewsController {
    ...
    public ResponseEntity<NewsResponse> getNews(
        ...
        NewsResponse newsResponse = newsService.getTopHeadLines(topHeadlinesQueryRequest,
    ...
    @GetMapping("/read")
    public ResponseEntity<UserArticleResponse> getReadArticles(@AuthenticationPrincipal UserDetailsImpl userDetails,
        ...
        UserArticleResponse readArticles = newsArticleService.getReadArticles(userDetails.getUsername(),
                page - 1, pageSize);
    ...
    public ResponseEntity<UserArticleResponse> getFavoriteArticles(
        ...
        UserArticleResponse favoriteArticles = newsArticleService.getFavoriteArticles(userDetails.getUsername(),
                page - 1, pageSize);
